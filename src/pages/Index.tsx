      ...
      <div className="container mx-auto px-4 relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="max-w-4xl mx-auto text-center space-y-6 mt-8">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-medium"> </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-12 pb-16">
          <div className="flex justify-center max-w-md mx-auto -mt-4">
            <div className="space-y-4 w-full">
              <Link to="/signin">
                <button className="w-full p-3 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all transform hover:scale-[1.02] active:scale-[0.98] py-[12px] mt-[10px] mb-[20px]">
                  Sign In
                </button>
              </Link>
