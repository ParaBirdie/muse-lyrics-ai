                ...
                <div className="space-y-6 text-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      We've sent you a verification link to complete your account setup. Please check your inbox and click the link to get started.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 pt-4">
                    <p className="text-sm text-muted-foreground">
                      ...
                      <button className="text-primary hover:text-primary/80 underline underline-offset-4 hover:no-underline transition-colors">
                        resend verification
                      </button>
                    </p>
                    
                    <Link to="/" className="inline-block">
                      <button className="w-full p-3 bg-secondary text-secondary-foreground font-semibold rounded-lg hover:bg-secondary/80 transition-all transform hover:scale-[1.02] active:scale-[0.98]">
                        Back to Home
                      </button>
                    </Link>
                  </div>
